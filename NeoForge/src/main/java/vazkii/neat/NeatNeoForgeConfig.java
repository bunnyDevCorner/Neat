...
public class NeatNeoForgeConfig {
	...
	private static class NeoForgeNeatConfig implements NeatConfig.ConfigAccess {
		...
		public NeoForgeNeatConfig(ModConfigSpec.Builder builder) {
			...
			maxDistance = builder.comment("Maximum distance in blocks at which health bars should render").define("max_distance", 8);
			...
			heightAbove = builder.comment("How far above the mob the health bars should render").define("height_above_mob", 1.0);
			...
			showAttributes = builder.comment("Show mob attributes such as arthropod or undead").define("show_attributes", false);
			showArmor = builder.comment("Show armor points").define("show_armor", false);
			groupArmor = builder.comment("Group 5 iron icons into 1 diamond icon").define("group_armor", false);
			...
			showMaxHP = builder.comment("Whether the maximum health of the mob should be shown").define("show_max_hp", false);
			showCurrentHP = builder.comment("Whether the current health of the mob should be shown").define("show_current_hp", false);
			showPercentage = builder.comment("Whether the percentage health of the mob should be shown").define("show_hp_percentage", false);
			...
			showOnPlayers = builder.comment("Whether bars on players should be shown").define("display_on_players", false);
			...
			enableDebugInfo = builder.comment("Show extra debug info on the bar when F3 is enabled").define("show_debug_with_f3", false);
			showEntityName = builder.comment("Show entity name").define("show_entity_name", false);
